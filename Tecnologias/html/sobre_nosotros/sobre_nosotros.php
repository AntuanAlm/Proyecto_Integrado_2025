...
<head>
    ...
    <!-- links de css -->
    <link rel="stylesheet" href="../../css/sobre_nosotros/sobre_nosotros.css">
    ...
    <!-- Links de las fuentes de google fonts -->
  ...
  <?php endif; ?>
    ...
    <h2 id="titulo-sobre-nosotros">Sobre nosotros</h2>
        ...
        <div class="texto-sobre-nosotros">
            <p id="texto-sobre-nosotros">En Autoescuela Almansa, nos dedicamos a formar conductores responsables y seguros. Nuestro equipo de instructores altamente capacitados está comprometido a brindarte la mejor educación vial posible. Con años de experiencia en la enseñanza de la conducción, te ofrecemos un enfoque personalizado y adaptado a tus necesidades.</p>
            <p id="texto-sobre-nosotros">Nuestra misión es garantizar que cada alumno adquiera las habilidades necesarias para convertirse en un conductor competente y seguro. Nos enorgullece ofrecer un ambiente de aprendizaje amigable y profesional, donde podrás sentirte cómodo mientras adquieres los conocimientos necesarios para obtener tu licencia de conducir.</p>
            <p id="texto-sobre-nosotros">Además, contamos con una amplia gama de vehículos modernos y bien mantenidos para que puedas practicar en condiciones óptimas. Ya sea que estés buscando obtener tu licencia por primera vez o necesites refrescar tus habilidades, estamos aquí para ayudarte en cada paso del camino.</p>
            <p id="texto-sobre-nosotros">En Autoescuela Almansa, tu seguridad y éxito son nuestra prioridad. ¡Únete a nosotros y comienza tu viaje hacia la conducción segura hoy mismo!</p>
        
            <a data-enlace="contacto" id="boton-contactar">Contacta con nosotros!</a> 

            <!-- AQUÍ HABRÁ QUE ENLAZARLO AL PHP DE CONTACTA CON NOSOTROS -->
